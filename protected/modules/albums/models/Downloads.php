...
class Downloads extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			array('id, date_entered, date_modified, created_by, modified_by', 'required'),
			array('status, deleted', 'numerical', 'integerOnly'=>true),
			array('id, album, created_by, modified_by', 'length', 'max'=>36),
			array('download_count', 'length', 'max'=>128),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, album, download_count, status, deleted, date_entered, date_modified, created_by, modified_by', 'safe', 'on'=>'search'),
		);
	}
