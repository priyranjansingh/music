      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo base_url()."/admin/genres"; ?>"><i class="fa fa-university"></i> <span>Genres</span></a></li>
            <li><a href="<?php echo base_url()."/admin/albums"; ?>"><i class="fa fa-university"></i> <span>Albums</span></a></li>
