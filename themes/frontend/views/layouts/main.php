...
//        Yii::app()->clientScript->registerCoreScript('jquery');
    ...
    <body>
        ...
        <script src="<?php echo $baseUrl; ?>/assets/scripts/jquery.min.js"></script> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/modernizr.min.js"></script> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/bootstrap.min.js"></script> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/browser-detect.js"></script> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/selectFx.js"></script> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/menu.js"></script>
        <script src="<?php echo $baseUrl; ?>/assets/scripts/jquery.flexslider.js"></script> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/jquery.countdown.js"></script> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/jquery.matchHeight.html"></script>
        <script src="<?php echo $baseUrl; ?>/assets/scripts/slick-min.html"></script>
        <script src="<?php echo $baseUrl; ?>/assets/scripts/slick.js"></script> 
        <!-- Put all Functions in functions.js --> 
        <script src="<?php echo $baseUrl; ?>/assets/scripts/functions.js"></script>
    </body>
